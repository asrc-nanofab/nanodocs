...
[click for local page](aluminum_markdown.md)
...
## View the original Google Doc 
(direct via share link)
...
## View the published google doc 
via embedded publish link from google
...
exported directly from the google doc url - embedded with javascript plugin (PDF.js)  

[Click to download the PDF](https://docs.google.com/document/d/1sY9ryit4Lrh_y8Saq49lXGpBvjVZQ8X8OhuhvA_iZF8/export?format=pdf)
...
<iframe src="../../../assets/pdfs/chem/Aluminum_Etch_SOP.pdf" width="100%" height="1000px" style="border: none;"></iframe>
