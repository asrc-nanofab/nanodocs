...
[:material-file-document-outline: Open the Google Doc](https://docs.google.com/document/d/1beyiXEaJvjsNaPcidsnvz1DwOyGI37BpkUN3oCp7gmo/preview){ .md-button }
[:material-file-pdf-box: View PDF](../../assets/pdfs/tools/Ellipsometer_SOP.pdf){ .md-button }
[:material-download: Download PDF](../../assets/pdfs/tools/Ellipsometer_SOP.pdf){ .md-button download="Ellipsometer_SOP.pdf" }
